    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="create.php" class="btn btn-sm btn-primary mb-4" style="color:white;">Tambah User</a>
                                    ...
                                    foreach ($datas as $key => $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="edit.php?id='.$data['id'].'" class="btn btn-sm btn-primary button-blue" style="color: white;">Edit</a>
